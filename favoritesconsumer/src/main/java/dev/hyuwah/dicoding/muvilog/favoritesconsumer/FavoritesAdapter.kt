...
import kotlinx.android.synthetic.main.row_favorite_list.view.*
...
class FavoritesAdapter(private val interaction: Interaction? = null) :
    ...
    class ViewHolder(itemView: View, private val interaction: Interaction?) :
